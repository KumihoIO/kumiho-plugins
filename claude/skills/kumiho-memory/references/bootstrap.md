...
2. `kumiho_memory_engage` **once** with a broad query (user's name, role, recent topics). This is the ONLY engage for the first turn — do not call engage or recall again.
